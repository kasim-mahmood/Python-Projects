...
while running:
    ...
    pygame.draw.circle(canvas,(255,0,0),[500,400],100,8)
    pygame.draw.circle(canvas,(255,165,0),[500,400],110,8)
    pygame.draw.circle(canvas,(255,255,204),[500,400],120,8)
    pygame.draw.circle(canvas,(0,255,0),[500,400],130,8)
    pygame.draw.circle(canvas,(173,216,230),[500,400],140,8)
    pygame.draw.circle(canvas,(0,0,255),[500,400],150,8)
    pygame.draw.circle(canvas,(160,32,240),[500,400],160,8)
